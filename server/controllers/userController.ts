...
export const createUserProject = async(req:Request, res:Response)=>{
    ...
    try{
        ...
        if(user && user.credits < 5){
            return res.status(403).json({message: 'Add credits yo create more projects'});
        }
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: `I've enhanced you prompt to: "${enhancedPrompt}"`,
                projectId: project.id
            }
        })
        await prisma.conversation.create({
        ...
        await prisma.conversation.create({
            data:{
                role: 'assistant',
                content: "I've created your website! You can now peview it and request any changes.",
                projectId: project.id
            }
        })
...
//ControllerFunction to Purschse Credits
